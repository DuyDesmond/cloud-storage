...
class ShareRepository:
    async def check_is_owner(self, conn: asyncpg.Connection, target_id: uuid.UUID, is_file: bool, user_id: uuid.UUID) -> bool:
    ...
    async def upsert_user_share(self, conn: asyncpg.Connection, target_id: uuid.UUID, is_file: bool, grantee_id: uuid.UUID, permission: str, created_by: uuid.UUID) -> None:
    ...
    async def revoke_user_share(self, conn: asyncpg.Connection, target_id: uuid.UUID, is_file: bool, grantee_id: uuid.UUID) -> None:
    ...
    async def upsert_public_link(self, conn: asyncpg.Connection, target_id: uuid.UUID, is_file: bool, share_token: str, password_hash: Optional[str], permission: str, created_by: uuid.UUID) -> str:
    ...
    async def revoke_public_link(self, conn: asyncpg.Connection, target_id: uuid.UUID, is_file: bool) -> None:
    ...
    async def get_share_state(self, conn: asyncpg.Connection, target_id: uuid.UUID, is_file: bool) -> list[dict[str, Any]]:
